...
<head>
    <meta charset="UTF-8">
    <title>Blangko Nilai - {{ $kelas }} - {{ $mapel }}</title>
    <style>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th colspan="5">Tugas / Ulangan Harian</th>
                <th rowspan="2" width="8%">UTS</th>
                <th rowspan="2" width="8%">UAS</th>
                <th rowspan="2" width="8%">Rata-rata</th>
            </tr>
            <tr>
                <th width="8%" style="height: 30px;">1</th>
                <th width="8%">2</th>
                <th width="8%">3</th>
                <th width="8%">4</th>
                <th width="8%">5</th>
